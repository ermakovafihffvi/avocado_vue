...
expenseCategoryRouter.delete('/:category_id/delete', function (req, res) {
...
expenseCategoryRouter.put('/:category_id/update', async function (req, res) {
...
expenseCategoryRouter.post('/add', function (req, res) {
